...
const RequestPDFForm = ({ articleId, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage("PDF request submitted! Check your email for the file.");
  ...
  return (
    <div className="mt-6">
      <form onSubmit={handleSubmit} className="space-y-4 w-[100%] mx-auto">
        <div>
